  ...
  return (
    ...
    >
      <video
        ...
        playsInline
      />
      <div className="absolute inset-0 bg-space/55" />

      <PageContainer className="relative z-10 py-16 md:py-24 lg:py-32">
        <div className="flex flex-col gap-12 lg:flex-row lg:items-start lg:justify-between lg:gap-16">
          ...
          <p className="max-w-[min(100%,320px)] font-mono text-xs uppercase leading-relaxed text-cream sm:text-sm md:text-base">
            {LEAD}
          </p>
        </div>

        <div className="mt-16 flex flex-col justify-between gap-10 lg:mt-24 lg:flex-row lg:gap-8">
          <div className="max-w-xl space-y-6 font-mono text-xs uppercase leading-relaxed text-cream/10 lg:text-sm">
            <p>{DECOR_LINES[0]}</p>
            <p>{DECOR_LINES[1]}</p>
          </div>
          <div className="hidden max-w-xl space-y-6 font-mono text-sm uppercase leading-relaxed text-cream/10 lg:block">
            <p>{DECOR_LINES[2]}</p>
            <p>{DECOR_LINES[0]}</p>
          </div>
        </div>

        <div className="mt-10 space-y-6 font-mono text-xs uppercase leading-relaxed text-space lg:hidden">
          <p>{DECOR_LINES[1]}</p>
          <p>{DECOR_LINES[2]}</p>
        </div>
      </PageContainer>
